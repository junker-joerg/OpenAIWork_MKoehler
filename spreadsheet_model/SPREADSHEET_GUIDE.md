...
1. Ein-Datei-Arbeitsmappe lokal erzeugen (`python3 spreadsheet_model/build_workbook.py`)
2. Arbeitsmappe öffnen (`hyperion_spreadsheet_model.xlsx`)
3. Parameter setzen
4. Jahres-Sheet(s) berechnen/duplizieren (`Y1`, `Y2`, ...)
5. Auswertung über Pivot-Tabellen und Charts

Keine Excel-spezifischen Features nötig.

Die XLSX wird aus den CSV-Quellen erzeugt via:
